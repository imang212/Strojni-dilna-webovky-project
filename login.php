...
elseif(strpos($fullUrl, "login=incorrectpass") == true) {
...
elseif(strpos($fullUrl, "login=emptyemailuid") == true) {
	echo "<p class='error'>".$lang['error4_prihlaseni']."</p>";
}
elseif(strpos($fullUrl, "login=emptypass") == true) {
	echo "<p class='error'>".$lang['error5_prihlaseni']."</p>";
}
elseif(strpos($fullUrl, "login=registered") == true) {
	sleep(3);
	echo "<p class='loginstatus'>".$lang['success_prihlaseni']."</p>";
}
elseif(strpos($fullUrl, "login=connect") == true) {
