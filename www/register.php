...
if(strpos($fullUrl, "register=connect") !== false) {
      echo "<p class='error'>".$lang['error1_register']."</p>";
}
elseif(strpos($fullUrl, "register=passdifferent") !== false) {
      echo "<p class='error'>".$lang['error2_register']."</p>";
}
elseif(strpos($fullUrl, "register=passlength") !== false) {
      echo "<p class='error'>".$lang['error3_register']."</p>";
}
elseif(strpos($fullUrl, "register=podminky") !== false) {
      echo "<p class='error'>".$lang['error4_register']."</p>";
}
elseif(strpos($fullUrl, "register=empty") !== false) {
      echo "<p class='error'>".$lang['error5_register']."</p>";
}
elseif(strpos($fullUrl, "register=emailincorrect") !== false) {
      echo "<p class='error'>".$lang['error6_register']."</p>";
}
elseif(strpos($fullUrl, "register=nameincorrect") !== false) {
      echo "<p class='error'>".$lang['error7_register']."</p>";
}
elseif(strpos($fullUrl, "register=surnameincorrect") !== false) {
      echo "<p class='error'>".$lang['error8_register']."</p>";
}
elseif(strpos($fullUrl, "register=usernameincorrect") !== false) {
      echo "<p class='error'>".$lang['error9_register']."</p>";
}
elseif(strpos($fullUrl, "register=numberincorrect") !== false) {
      echo "<p class='error'>".$lang['error10_register']."</p>";
}
elseif(strpos($fullUrl, "register=passincorrect") !== false) {
      echo "<p class='error'>".$lang['error11_register']."</p>";
}
elseif(strpos($fullUrl, "register=usernameexist") !== false) {
      echo "<p class='error'>".$lang['error12_register']."</p>";
}
elseif(strpos($fullUrl, "register=emailexist") !== false) {
      echo "<p class='error'>".$lang['error13_register']."</p>";
}
elseif(strpos($fullUrl, "register=success") !== false) {
