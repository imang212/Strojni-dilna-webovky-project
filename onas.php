...
<html>
	...
	<body>
		<div class="container">
			...
			<article class="main">
				<div class="onas_bar">
				  <h2 class="nadpis_onas"><?php echo $lang['nadpis_onas'];?></h2>
				  <div class="onas_bar2">
					<div class='onas_symbol'><ion-icon class='onas_pismo' name="information-circle-outline"></ion-icon></div>
					<div class="info">
						<p><?php echo $lang['text_onas'];?></p>
					</div>
				  </div>
				</div>
			</article>
